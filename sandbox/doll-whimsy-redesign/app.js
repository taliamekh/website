...
const projects = [
  ...
  },
  {
    ...
    title: 'Spocket',
    summary: 'React and Gemini AI assistant for the School Notes workspace. Live, not a mockup.',
...
const workspaceItems = [
  ...
  {
    title: 'Expenses',
    href: isLocalPreview ? '/expenses/spending-tracker/dist/' : '/expenses/'
  },
  ...
  home: () => `
    <section class="page home-page" aria-labelledby="home-title">
      <div class="home-frame">
        <img class="home-border" src="assets/home-border-transparent.png" alt="" aria-hidden="true">
  ...
  workspace: () => `
    <section class="page workspace-page" aria-labelledby="workspace-title">
      <header class="page-heading workspace-heading">
        ...
        <button class="lock-preview" type="button" data-lock-preview>Preview lock screen</button>
      </header>
  ...
  portal: () => `
    <section class="page portal-page" aria-labelledby="portal-title">
      <div class="portal-layout">
        ...
        <form class="access-card" id="prototype-portal-form" autocomplete="off">
          <label for="portal-key">Access key</label>
          <div class="key-field">
            <input id="portal-key" name="prototype-access-key" type="password" placeholder="your-client-key" autocomplete="new-password">
...
function render(option, page, focus = false) {
  ...
  body.classList.toggle('sr-auth-unlocked', page === 'workspace');
...
function bindPageInteractions(page) {
  ...
  if (page === 'workspace') {
    pageContent.querySelector('[data-lock-preview]').addEventListener('click', () => {
      openModal('', 'Workspace access', '', '<label class="modal-field">Password<input type="password" placeholder="Password"></label><button type="button" class="primary-action" data-close-modal>Unlock</button>');
      modal.classList.add('workspace-lock-modal');
    });
  ...
  if (page === 'portal') {
    const form = pageContent.querySelector('#prototype-portal-form');
    ...
    form.addEventListener('submit', event => {
      ...
      status.textContent = key.value.trim() ? 'Design preview only — no key was submitted.' : 'Enter an access key to continue.';
    });
  }
